...
from graphicsViewer.draw import DrawFWMAV
...
class FWMAVViewer():
    def __init__(self):
        ...
        self.window.setCameraPosition(distance=2) # distance from center of plot to camera
    ...
    def update(self, state):
        ...
        if not self.plot_initialized:
            self.mav_plot = DrawFWMAV(state, self.window)
